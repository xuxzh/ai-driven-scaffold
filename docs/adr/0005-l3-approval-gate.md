...
L3 任务在**实施 session 启动前**必须收用户的"明确批准"信号。按 ADR-0002 沉淀的"硬约束三件套"句式落地：
...
- 前置 ADR：[0001-task-level-governance.md](0001-task-level-governance.md)、[0002-verify-hard-gate.md](0002-verify-hard-gate.md)、[0003-multi-session-l2.md](0003-multi-session-l2.md)、[0004-l2-spec-and-plan.md](0004-l2-spec-and-plan.md)
- 基线文档：[../ai/task-levels.md](../ai/task-levels.md)（同步修订 L3 段）、[../ai/ai-role-boundaries.md](../ai/ai-role-boundaries.md)
